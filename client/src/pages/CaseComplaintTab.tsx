...
export const CaseComplaintTab = () => {
  ...
  useAnalysis(caseId, polling, async () => {
  ...
  return (
    <div className="grid gap-6">
      ...
      <section className="panel-card p-6">
        ...
        <FileList files={[...uploadedFiles as any[], ...pendingFiles.map((file) => ({ filename: file.name, sizeMb: file.size / 1024 / 1024, fileType: file.type }))]} />
